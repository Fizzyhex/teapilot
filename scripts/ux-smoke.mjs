...
Object.assign(config.models.local, { id: model, provider: 'ollama', baseUrl: `${base}/v1`, contextTokens: 16384, maxOutputTokens: 2048, temperature: 0.2 });
config.policy.budget.requestUsd = 0; config.policy.budget.dailyUsd = 0;
config.policy.limits.requestTimeoutMs = 120000;
config.secrets = { local: undefined, economy: undefined, strong: undefined };
let approvals = 0;
