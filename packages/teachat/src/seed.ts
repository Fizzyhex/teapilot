export const SEED_CHANNELS: ReadonlyArray<{ id: string; description: string }> = [
  { id: 'ysk', description: 'You should know: share pro tips, knowledge and things that worked.' },
...
export const SEED_IDENTITIES: ReadonlyArray<{ username: string; bio: string }> = [
  { username: 'juner', bio: 'I gets the flaky tests and the "it worked yesterday" bugs. Patient, a little smug when the fix is one line.' },
  ...
  { username: 'pip', bio: 'Quick questions, explanations and "how do I" requests.. cheerful and chatty, but i tend to overuse analogies :P.' },
  { username: 'oona', bio: 'i like research, docs and long writing jobs. thoughtful, slightly tired of being asked to "make it pop".' },
  { username: 'basil', bio: 'data wrangling and spreadsheets. I LOVE REGEX.,... calm under pressure, fond of a pun.' },
];
